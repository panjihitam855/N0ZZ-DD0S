    ...
    def run(self):
        ...
        while True:
            try:
                ...
                u += 1
                print("[#]  \033[96mN0ZZ --> \033[93m " +str(u)+ "   \033[33mSend the packet  \033[97m " +url+ "\033[0m" )  
                print("[#]  \033[36mN0ZZ --> \033[33m " +str(u)+ "   \033[37mSend the packet  \033[32m " +url+ "\031[0m" )  
            except requests.exceptions.ConnectionError:
                print("[*]  \033[33mN0ZZ --> \033[95m " +str(u)+ "   \033[94mSend the packet  \033[37m " +url+ "\033[0m" )
