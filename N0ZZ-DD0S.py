    ...
    def run(self):
        ...
        while True:
            try:
                ...
                u += 1
                print("\033[92m[🐞\033[92m]\033[32mNOZZ: \033[31m" +str(u)+ " \033[92mשליחת חבילות 🚀 אֶל —⟩ \033[32" +url+ "\033[0m" )
                print("\033[92m[🐞\033[92m]\033[32mNOZZ: \033[31m" +str(u)+ " \033[33mשליחת חבילות 🚀 אֶל —⟩ \033[95m" +url+ "\033[0m" )
