    ...
    def run(self):
        ...
        while True:
            try:
                ...
                u += 1
                print("\033[90m[☀️\033[90m]\033[96mNOZZ: \033[94m " +str(u)+ "  \033[32mשלח את החבילה אל   " +url+ "\033[0m" )
                print("\033[90m[☀️\033[90m]\033[96mNOZZ: \033[94m " +str(u)+ "  \033[95mשלח את החבילה אל   " +url+ "\033[0m" )
